...
## Project Name
1. 'Data Sharing Policy' (Boolean)
    a. Yes
    b. No
    
2. 'Data Citation Policy' (Factor)
    + No mention
    + Implied
    + Mentioned
    + Explicitly encouraged
    + Requried, but not explicitly tried to editorial
...
3. 'Data Citation Policy' (Factor)
    ...
    e. Requried, but not explicitly tried to editorial
